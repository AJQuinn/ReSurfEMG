...
This file contains functions to extract output parameters from
EMG arrays.
"""
...
def times_under_curve(
    ...
    smoothed_breath = evl.running_smoother(breath_arc)
...
def pseudo_slope(
    ...
    if smoothing:
        smoothed_breath = evl.running_smoother(pos_arc)
        abs_time = smoothed_breath.argmax()
    else:
